...
<body id="ce_3">
    ...
    <!--allwidth -->
        <div class="allwidth">
            ...
            <s:iterator value="articleTxtlist">
            <tr><td><input type="checkbox" name="test"  value="<s:property value="proId" />"/></td>
                ...
                <td>
                   <s:property value="articleAuthor" />
                </td>
                 <td>
                   <s:property value="createDate" />
                </td>
                <td align="center">
                    <a href="articleTxt_delete?id=<s:property value="articleId" />" class="btn_small_del" title="删除"></a>
                    <a href="articleTxt_updateui?id=<s:property value="articleId" />" class="btn_small_update" title="修改"></a>
                </td>
            </tr>
            </s:iterator>
            </table>
